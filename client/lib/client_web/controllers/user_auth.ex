defmodule ClientWeb.UserAuth do
  import Plug.Conn
  ...
  # @max_age 60 * 60 * 24 * 60
  @max_age 60 * 28.8
  @remember_me_cookie "_client_web_user_remember_me"
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      ClientWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  def fetch_current_user(conn, _opts) do
    ...
    user = user_token && keys_to_atoms(get_session(conn, "current_user"))
  ...
  defp signed_in_path(_conn), do: "/lists"
